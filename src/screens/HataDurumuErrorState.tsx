...
export function HataDurumuErrorState(props: HataDurumuErrorStateProps) {
  return (
    <>
      ...
      {/* Primary Action */}
      <button className="flex-1 bg-primary text-on-primary font-label-md text-label-md py-3 px-md rounded-lg min-h-[44px] hover:bg-primary-fixed transition-colors flex items-center justify-center gap-2">
      <span className="material-symbols-outlined text-[18px]">refresh</span>
                          Tekrar Dene
                      </button>
      {/* Secondary Action */}
      <button className="flex-1 bg-transparent border border-outline-variant text-on-surface font-label-md text-label-md py-3 px-md rounded-lg min-h-[44px] hover:bg-surface-variant transition-colors flex items-center justify-center gap-2">
